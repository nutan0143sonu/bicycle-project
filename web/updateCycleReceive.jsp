    ...
    <body>
      ...
      %>
        <%   
            ...
            if(request.getParameter("submit")!=null)
             ...
             Class.forName("com.mysql.jdbc.Driver");
              ...
              Statement st5=con.createStatement();
                ...
                id =request.getParameter("cycle_id");
               System.out.println("cycle_id on updat cycle receive \t"+id);
                 receive_id =request.getParameter("receive_id");
                 System.out.println("receive id on update cycle receive \t"+receive_id);
               ...
               String sql="select * from receive_cycle where cycle_id= '"+id+"' and receive_id='"+receive_id+"'";
         ...
         String sql3="select quantity from cycle where cycle_id = '"+id+"' ";
        ...
        if(rs3.next())
        {
           ...
           System.out.println("cycle table quantity\t"+qua);
         
        }
        qua=qua-requantity1;
        System.out.println("after subtracting receive quantity cycle table quantity\t"+qua);
         ...
         int dis=Integer.parseInt(discount);
          ...
          System.out.println("grand total\t"+total);
               ...
               String sql7="select cycle_quantity from request_product where request_id='"+request_id+"' and cycle_id='"+id+"'";
               Statement s=con.createStatement();
               ResultSet r=s.executeQuery(sql7);
               if(r.next())
               {
                     request_quantity1=r.getInt("cycle_quantity");
           ...
           boolean j=   stt.execute("update cycle set quantity='"+qua+"' where cycle_id='"+id+"'");
            System.out.print("update cycle set quantity='"+qua+"' where cycle_id='"+id+"'");
            if(request_quantity1>quan)
               {
                   ...
                   st3.execute("update receive_cycle set receive_quantity="+quan+",left_quantity="+left+",discount="+discount+",per_amount="+amount+",total="+total+" where cycle_id='"+id+"'");
               ...
               else
               {
                left=0;
                System.out.println("left quantity\t"+left);
                boolean i=st3.execute("update receive_cycle set receive_quantity="+quan+", left_quantity="+left+", discount="+discount+", per_amount="+amount+", total="+total+" where cycle_id='"+id+"'");
