...
<%
             Class.forName("com.mysql.jdbc.Driver");
              ...
              Statement st=con.createStatement();
               ...
               String sql1="select quantity from parts where part_id='"+id+"'";
               ...
               System.out.println("part id is on update form page \t "+id);
              String sql="select * from customer_part_bill where part_id= '"+id+"'";
...
<html>
    ...
    <body>
        <form action="updatePartBill.jsp" method="get">
            <table>
                <tr><th colspan="2"><h1>Update Product</h1></tr>
                <tr><td> <input type="hidden" name="part_id" value="<%=id%>"><input type="hidden" name="bill_id" value="<%=bill%>"></td></tr>
