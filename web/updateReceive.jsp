...
<html>
    ...
    <body>
      ...
      %>
        <%   
             ...
             Class.forName("com.mysql.jdbc.Driver");
              ...
              Statement st5=con.createStatement();
               ...
               System.out.println("cycle id on update receive page"+id);
        ...
        %>
            <form  action="updateCycleReceive.jsp" method="post">
            <table>
                <tr><th colspan="2"><h1>Update Product</h1></tr>
                <tr><td><input type="hidden" name="cycle_id" value="<%=id%>"></td></tr>
