<%-- 
    Document   : addReceiveCycle
    Created on : Apr 16, 2018, 3:53:09 PM
    Author     : Nutan Gupta
--%>
...
<html>
    <head>
        ...
        <title>ADD Receive Cycle Page</title>
    </head>
    <body>
        <%!
           int quantity1;
        ...
        <%
          ...
          if(request.getParameter("submit")!=null)
          {
             ...
             boolean i=st.execute("insert into receive_cycle(receive_id,cycle_id,receive_quantity,left_quantity,gst,discount,per_amount,total)values('"+id+"','"+cycle+"','"+requantity+"','"+left+"','"+gst+"','"+discount+"','"+peramount+"','"+total1+"')");
            
             String sql2="select quantity,gst,per_amount,discount from cycle where cycle_id='"+cycle+"'";
             ...
             st1.execute("update cycle set quantity="+qua+",gst="+gst+",per_amount="+peramount+" where cycle_id='"+cycle+"'");
