...
<html>
    ...
    <body>
        ...
        Class.forName("com.mysql.jdbc.Driver");
              ...
              String sql = "DELETE FROM customer_cycle_bill WHERE cycle_id='" + id+ "' and bill_id='"+bill+"'";
              boolean ps=st.execute(sql); 
                ...
                if(increment==1)
                {
                   out.print("<script>alert(\"cycle deleted\");</script>");
                }
                else 
                  out.print("<script>alert(\"cycle  not deleted\");</script>");
