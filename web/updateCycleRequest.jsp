        ...
        <%
             Class.forName("com.mysql.jdbc.Driver");
              ...
              Statement st5=con.createStatement();
               ...
               id =request.getParameter("cycleid");
               request_id=(String)session.getAttribute("request_id");
               System.out.println("cycle id on update page"+id);
              String sql="select * from request_product where cycle_id= '"+id+"' and request_id='"+request_id+"'";
          ...
          if(rs.next()){
              qua=rs.getInt("cycle_quantity");
              System.out.println("quantity present in request_product\t"+qua);
          }
          String sql2="select quantity from cycle where cycle_id='"+id+"'";
          System.out.println(sql2);
          ResultSet rs2=st2.executeQuery(sql2);
          while(rs2.next()){
              quan=rs2.getInt("quantity");
              System.out.println("quantity present cycle table\t"+quan);
          }
        %>
        <form action="updateCycleRequest1.jsp" method="get">
            <table>
                <tr><th colspan="2"><h1>Update Product</h1></tr>
                <tr><td><input type="hidden" name="cycle_id" value="<%=id%>"><input type="hidden" name="request_id" value="<%=request_id%>"></td></tr>
