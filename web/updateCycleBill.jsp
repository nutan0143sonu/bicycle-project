    ...
    <body>
      ...
      %>
        ...
        if(rs3.next())
        {
         ...
         System.out.println("quantity in cycle table qua=\t  "+qua);
        }
       ...
       System.out.println("discount in textbox \t "+dis);
        if(quan<qua)
        {
              ...
              {   
                  ...
                  System.out.println("quantity in customer cycle  bill table q2= \t "+q2);
                  String gst=rs.getString("gst");
                 
                  int gt=Integer.parseInt(gst);
                 
                   System.out.println("gst in customer cycle  bill table gt= \t "+gt);
                   ...
                   String sql1="update customer_cycle_bill set quantity="+quan+",discount="+discount+",per_amount="+peramount+",total="+total1+" where cycle_id='"+id+"'  "; 
                     st2.execute(sql1);
                    try{
                     if(q2<quan)
                     {
                          ...
                          int cq=qua-cqua;
                          System.out.println("Now cycle table quantity is cq= \t "+cq);
                         String sql2="update cycle set quantity="+cq+" where cycle_id='"+id+"'";
                         st4.execute(sql2);
                     }
                     else
                     {
                         ...
                         int cq1=cqua1+qua;
                         System.out.println("Now present quantity in cycle table cql= \t "+cq1);
                         String sql5="update cycle set quantity="+cq1+" where cycle_id='"+id+"'";
